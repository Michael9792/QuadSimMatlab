...
for iter = 1:max_iter
    ...
    % QP.UpdateQuadPlot actually has 4 inputs, but here only pass 3 inputs.
    % cause UpdateQuadPlot(Q, state, des_state, time) the first parameter
    % is Q, not need to pass in.
...
% Plot attitude angle
h_ang = figure('Name', ['Quad angle']);
plot_state(h_ang, QP.state_hist(7:9,:), QP.time_hist, 'euler', 'vic');
% plot_state(h_angvel, QP.state_des_hist(4:6,:), QP.time_hist, 'vel', 'des');
