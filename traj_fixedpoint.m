function [ desired_state ] = traj_fixedpoint(t_real, state)
% TRAJ_FIXEDPOINT: Generate the trajectory passing through all
...
desired_state.pos(1,1) = 0;
desired_state.pos(2,1) = 0;
