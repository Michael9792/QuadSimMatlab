    ...
    methods
        ...
        function Q = QuadPlot(qn, state, wingspan, height, color, max_iter, h_3d)
            ...
            Q.h_m13 = plot3(Q.h_3d, ...
                ...
                Q.motor(2,[1 3]), ...
                Q.motor(3,[1 3]), ...
                '-ko', 'MarkerFaceColor', [1 0 0], 'MarkerSize', 5);
            ...
            Q.h_qn = text(...
                Q.motor(1,1) + Q.text_dist, ...
                Q.motor(2,1) + Q.text_dist, ...
                Q.motor(3,1) + Q.text_dist, num2str(qn));
            hold(Q.h_3d, 'off')
        end
        ...
        function UpdateQuadHist(Q)
            ...
            Qddddd = stateToQd(Q.state);
            Q.state_hist(:,Q.k) = [Q.state(1:6);Qddddd.rot];
